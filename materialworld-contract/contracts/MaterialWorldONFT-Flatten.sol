// File @layerzerolabs/solidity-examples/contracts/interfaces/ILayerZeroUserApplicationConfig.sol@v0.0.12
...
// File @layerzerolabs/solidity-examples/contracts/interfaces/ILayerZeroEndpoint.sol@v0.0.12
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    function _beforeTokenTransfer(address from, address to, uint firstTokenId, uint batchSize) internal virtual {}
     ...
     * To learn more about hooks, head to xref:ROOT:extending-contracts.adoc#using-hooks[Using Hooks].
     */
    function _afterTokenTransfer(address from, address to, uint firstTokenId, uint batchSize) internal virtual {}
    ...
    function __unsafe_increaseBalance(address account, uint amount) internal {
        _balances[account] += amount;
    }
}

// File @layerzerolabs/solidity-examples/contracts/interfaces/ILayerZeroReceiver.sol@v0.0.12
...
// File contracts/MaterialWorldONFT.sol
...
contract MaterialWorldONFT is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(string memory tokenUri) external payable {
        require(nextTokenId + 1 <= MAX_MINT_ETHEREUM, "Material World: Mint exceeds supply");
